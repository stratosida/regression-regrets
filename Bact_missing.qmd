...
THis seciton reports the IDA analyses for missing data. The Section headers (i.e. M1) correspond to the IDA analysis plan in @sec-IDA_plan.
...
m3_ard |> 
  ...
  select(Set, n_cases, pct_cases, SEXC, AGEGR01, AGEGR01C ) |>
...
```{r m3-dendogram, message =FALSE, warning =FALSE , echo=FALSE, fig.height=14, fig.width=13}

#fig.cap="Clustered variables by percentage observations discordantly missing [by variable percentage missing]"
