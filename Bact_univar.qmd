...
html(describe(medium_predictors))
...
html(describe(remaining_predictors))
...
TODO: Do we want to plot side by side all variables? Would need the routine to calaculte sigma in the function. 
...
library(patchwork)
library(purrr)
#sigmas <- map(suggested_transforms, ~ pluck(.x, "const")) 
