...
```{r pl-setup, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
...
```{r pl03, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
...
```{r pl03b, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
y <-
  cbind(
    log(x),
...
```{r pl04, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
x <- x * 10
...
```{r pl05, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
#| layout-ncol: 5 
...
```{r pl07, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
#| layout-ncol: 3 
...
```{r pl08, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
#| layout-ncol: 3 
...
```{r pl09, message=FALSE, warning=FALSE, echo=TRUE, fig.height=3}
#| layout-ncol: 3 
